...
const MovieDetail = async ({ params: { movieId } }) => {
  ...
  return (
    <div className="md:container px-10 mx-auto py-5 mt-8">
      <h1 className="text-center text-white text-3xl m-5">{title}</h1>
      {videoKey && <VideoSection videoKey={videoKey} />}
      <div className="flex items-center mt-3 md:mt-4 gap-3">
        <Link
          href={"/movies"}
          className="bg-red-700 rounded-md py-1 md:py-2 px-2 md:px-4 w-auto text-xs lg:text-lg font-semibold flex flex-row items-center hover:bg-red-500 transition mt-2"
        >
